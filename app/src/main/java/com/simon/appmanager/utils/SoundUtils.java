...
public class SoundUtils {
    ...
    private SoundUtils() {
        try {
            ...
            mVibrator = (Vibrator) MyApplication.getInstance().getSystemService(Service.VIBRATOR_SERVICE);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
     ...
     * @param volume 0.50f
     */
    public void playSoundByMedia(int rawId, int volume, boolean vibrate) {
        /*震动*/
        isVibrate = vibrate;
        if (vibrate) {
